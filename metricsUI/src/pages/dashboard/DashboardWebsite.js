...
function refresh_DashboardResource(setAvailableResourcesLoaded, setSamplesTimeLoaded, setSamplesSizeLoaded){
  ...
  if(!getSamplesSizeLoaded) {
    ...
    return (
        <>
            ...
            <PageTitle title="Dashboard Websites" button="See all websites monitored"
          />
          <Grid container spacing={4}>
            <Grid item xs={12}>
              ...
              >
                <TableWebsites data={tableResource} p1 = {setSamplesTimeLoaded} p2 = {setSamplesSizeLoaded}/>
              </Widget>
            </Grid>
                    ...
                    <div className={classes.mainChartHeader}>
                      ...
                      <Select
                          ...
                          onChange={e => {
                            ...
                            refresh_DashboardResource(setAvailableResourcesLoaded, setSamplesTimeLoaded, setSamplesSizeLoaded);}}
                          input={
                            <OutlinedInput
                                labelWidth={0}
                                classes={{
