from mysql_config.WebMonitoring.generators.website.tests.website_expected_size import \
    EXPECTED_DAILY_WEBSITE_GENERATE_SAMPLES_QUERIES_SIZE, EXPECTED_WEEKLY_WEBSITE_GENERATE_SAMPLES_QUERIES_SIZE, \
...
from mysql_config.WebMonitoring.generators.website.tests.website_expected_time import \
    EXPECTED_DAILY_WEBSITE_GENERATE_SAMPLES_QUERIES, EXPECTED_WEEKLY_WEBSITE_GENERATE_SAMPLES_QUERIES, \
