...
from mysql_config.WebMonitoring.generators.resource.tests.resource_expected_size import \
    EXPECTED_DAILY_RESOURCE_GENERATE_SAMPLES_QUERIES_SIZE, EXPECTED_WEEKLY_RESOURCE_GENERATE_SAMPLES_QUERIES_SIZE, \
...
from mysql_config.WebMonitoring.generators.resource.tests.resource_expected_time import \
    EXPECTED_DAILY_RESOURCE_GENERATE_SAMPLES_QUERIES, EXPECTED_WEEKLY_RESOURCE_GENERATE_SAMPLES_QUERIES, \
