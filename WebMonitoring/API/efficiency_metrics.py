...
def get_results_resource_get_efficiency(result_args_get_time,
    ...
    for i in range(result_args_get_time):
        result_args_get_efficiency[i] = div_0(result_args_get_size[i],
                                              result_args_get_time[i])
    for i in range(result_args_old_get_time):
        result_args_old_get_efficiency[i] = div_0(result_args_old_get_size[i],
                                                  result_args_old_get_time[i])

    list_sample_efficiency = []
    for i in range(list_sample_time):
