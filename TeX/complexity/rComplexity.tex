...
\qed
 ...
 \textbf{Transitivity in $rComplexity$:}  \\  $ f \in \Theta_{r}(g(n)),  g \in \Theta_{r'}(h(n)) \Rightarrow  f \in \Theta_{r \cdot r'}(h(n))$    
 \\\textit{Proof}:
...
\textit{Proof}:
Is similar with the proof for Big Theta, with the inequalities becoming $f(n) \leq c \cdot g(n)$.
\qed
\hfill\break
 \\
Also, 
...
\textit{Proof}:
Is similar with the proof for Big Theta, with the inequalities becoming $f(n) \geq c \cdot g(n)$.
\qed
\hfill\break
 \\
 Also, 
...
\begin{itemize}
  \item \textbf{Big Theta}:  \\
  If $ \lim_{n\to\infty} \dfrac{f(n)}{g(n)} = 0 \Rightarrow  h \in \Theta_{q}(g) $. \\
...
\hfill\break
  ...
  If $ \lim_{n\to\infty} \dfrac{f(n)}{g(n)} = \infty \Rightarrow  h \in \Theta_{r}(f) $. \\
\textit{Proof}:
...
\hfill\break
  ...
  If $ \lim_{n\to\infty} \dfrac{f(n)}{g(n)} = t, \ t \in \mathbb{R}_{+} \Rightarrow  h \in \Theta_{r} \left( f + \dfrac{r}{q} \cdot g \right) $. \\
\textit{Proof}:
