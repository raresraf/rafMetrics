...
\begin{remark} Reflexivity does not hold in $rComplexity$ for small r-O notation. 
\[ f \notin o_{r}(f(n)) \]
...
\begin{remark} Reflexivity does not hold in $rComplexity$ for small r-Omega notation.
\[ f \notin \omega_{r}(f(n)) \]
...
\begin{theorem} Transitivity in $rComplexity$ - Big r-Theta notation:  \\  $ f \in \Theta_{r}(g(n)),  g \in \Theta_{r'}(h(n)) \Rightarrow  f \in \Theta_{r \cdot r'}(h(n))$    
\end{theorem} 
\begin{proof} 
