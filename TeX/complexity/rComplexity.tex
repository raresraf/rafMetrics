...
\begin{theorem}  \textbf{Reflexivity in $rComplexity$:} - Big r-Theta notation  \[ f \in \Theta_{r} \left( \frac{1}{r} \cdot f(n) \right)\ \forall r \neq 0 \]
\end{theorem} 
\begin{proof}
...
\begin{theorem} \textbf{Big r-O Conversion}:  
