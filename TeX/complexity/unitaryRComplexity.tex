...
\begin{remark} Reflexivity in $1-Complexity$ - Small 1-o notation:
$ f \notin o_{1}(f(n)) $ 
\end{remark} 
\begin{remark} Reflexivity in $1-Complexity$ - Small 1-Omega notation:
$ f \notin \omega_{1}(f(n)) $ 
\end{remark} 
...
\end{proof} 
\begin{lemma} Transitivity in $1-Complexity$ - small notations:
