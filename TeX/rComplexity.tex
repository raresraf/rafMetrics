...
The reflexivity does not hold for Small \textit{r-}Theta and Small \textit{r-}Omega, as these two sets are equal with the classical sets defined in \textit{Bachmann–Landau notations}:
