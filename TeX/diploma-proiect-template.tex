...
\newcommand{\ProjectSubtitleEN}{A new approach to the traditional ways of measuring complexity of algorithms and estimating running times given the chosen architecture, in the context of dynamic infrastructure}
...
\input{complexity/rComplexity.tex}
\input{complexity/unitaryRComplexity.tex}
\input{complexity/algoToComplex.tex}
\input{complexity/practicalRComplexity.tex}
\input{web/web.tex}
\input{platform/platform.tex}
\input{chess/chess.tex}
